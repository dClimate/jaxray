 ...
 */
export function parseCFTimeUnits(unitsStr) {
 ...
 */
export function cfTimeToDate(value, unitsStr, calendar = 'proleptic_gregorian') {
 ...
 */
export function isTimeCoordinate(attrs) {
    if (!attrs)
        return false;
 ...
 */
export function formatCoordinateValue(value, attrs) {
...
//# sourceMappingURL=cf-time.js.map